...
d3.queue()
	...
	.defer(d3.json, "DataExplorationUtility?op=TotalReviews5") // Load DataExploration json
	.await(ready);
      ...
      .attr("class", "counties")
			...
			.on("mouseover", function(d){
				if (typeof(revCount[d.id]) != "undefined"){
					document.getElementById("revCount").innerHTML = "State: " + state[d.id] + "\tReview Count :" + revCount[d.id];		
				}
				else{
					document.getElementById("revCount").innerHTML = "State: N/A\tReview Count: 0";		
				}
